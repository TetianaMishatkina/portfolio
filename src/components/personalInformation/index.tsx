		...
		<StyledPersonalInformation>
			...
			<StyledInfoContainer>
				<StyledQuestionBlock>
					...
					<StyledInfo>
						Hello! I'm a Junior Frontend Developer committed to building quality
						projects.
				...
				<StyledQuestionBlock>
					...
					<StyledLinkeDin>
						<a href="https://www.linkedin.com/in/tetiana-m-41a124254/">
							linkedin.com/in/tetiana-mishatkina
						</a>
					</StyledLinkeDin>
				</StyledQuestionBlock>
			</StyledInfoContainer>
